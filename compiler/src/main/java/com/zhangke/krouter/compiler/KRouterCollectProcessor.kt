 ...
 *     private lateinit var `com_zhangke_krouter_test_Screen#com_zhangke_krouter_test_TestScreen`: TestScreen
 *     private lateinit var `com_zhangke_krouter_test_Screen#com_zhangke_krouter_test_MainScreen`: MainScreen
 *     private lateinit var `com_zhangke_krouter_test_TabScreen#com_zhangke_krouter_test_SettingsScreen`: SettingsScreen
 * }
 * ```
 *
 * 专门用于收集路由信息的处理器
